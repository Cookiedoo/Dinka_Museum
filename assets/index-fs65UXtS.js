...
void main() {
    ...
    `,blending:2}));o.position.y=6.5,n.add(o),n.position.set(e,0,t),hd.add(n)}var Pd=90,Fd=new Dr,Id=new Float32Array(Pd*3),Ld=new Float32Array(Pd*3),Rd=new Float32Array(Pd);for(let e=0;e<Pd;e++)Id[e*3+0]=(Math.random()-.5)*32,Id[e*3+1]=Math.random()*10+1,Id[e*3+2]=(Math.random()-.5)*24-4,Ld[e*3+0]=(Math.random()-.5)*.0015,Ld[e*3+1]=(Math.random()-.5)*8e-4,Ld[e*3+2]=(Math.random()-.5)*.0015,Rd[e]=Math.random()*Math.PI*2;Fd.setAttribute(`position`,new fr(Id,3));var zd=new Qi(Fd,new qi({color:16773328,size:.06,transparent:!0,opacity:.5,sizeAttenuation:!0,depthWrite:!1,blending:2}));hd.add(zd);var Bd=new mu,Vd=new Qa;function Hd(e,t,n,r){let i=qd.indexOf(n);t.remove(n),r.userData.idx=e,t.add(r),qd[i]=r}function Ud(e){let t=[];return e.traverse(e=>{if(e.isMesh){let n=e;if(n.castShadow=!0,n.receiveShadow=!0,n.material)if(Array.isArray(n.material))n.material=n.material.map(e=>{let n=e.clone();return n.emissive||=new Y(16774366),n.emissiveIntensity=.05,t.push(n),n});else{let e=n.material.clone();e.emissive||=new Y(16774366),e.emissiveIntensity=.05,n.material=e,t.push(e)}}}),t}function Wd(e,t,n,r,i){Bd.load(r.src,a=>{let o=a.scene,s=new Jn().setFromObject(o),c=new G;s.getSize(c);let l=.95/Math.max(c.x,c.y,c.z)*(r.scale||1);o.scale.setScalar(l),r.rotationOffset&&(o.rotation.x+=r.rotationOffset.x||0,o.rotation.y+=r.rotationOffset.y||0,o.rotation.z+=r.rotationOffset.z||0);let u=new Jn().setFromObject(o),d=new G;u.getCenter(d),o.position.x=-d.x,o.position.z=-d.z,o.position.y=-u.min.y;let f=new wn;f.add(o),f.position.x=r.xOffset||0,f.position.z=r.zOffset||0,f.position.y=3.1+(r.yOffset||0),f.rotation.y=i;let p=Ud(o);f.userData.materials=p,f.userData.baseY=f.position.y,f.userData.baseRotY=i;let m=1.1,h=new X(new aa(m,m*1.4,m),new Vr({visible:!1}));h.position.y=.5,h.userData.isClickBubble=!0,f.add(h),Hd(e,t,n,f)},void 0,e=>console.error(`Failed to load ${r.src}:`,e))}function Gd(e,t,n,r,i){Vd.load(r.src,r=>{r.colorSpace=ze;let a=r.image.width/r.image.height,o=1.1,s=o/a,c=.05,l=.06,u=new wn,d=new ya({color:3811866,roughness:.6,metalness:.05}),f=new X(new aa(o+l*2,s+l*2,c),d);f.castShadow=!0,f.receiveShadow=!0,u.add(f);let p=new ya({color:15919312,roughness:.8}),m=new X(new ca(o,s),p);m.position.z=c/2+.001,u.add(m);let h=new ya({map:r,roughness:.7,emissive:new Y(16774366),emissiveIntensity:.05,emissiveMap:r}),g=new X(new ca(o*.92,s*.92),h);g.position.z=c/2+.002,u.add(g);let _=new ya({color:2759182,roughness:.7}),v=new X(new aa(.04,s+l,.04),_);v.position.z=-c/2-.02,v.rotation.x=.15,v.castShadow=!0,u.add(v),u.position.y=3.1+(s+l*2)/2+.03,u.rotation.y=i,u.userData.materials=[h],u.userData.baseY=u.position.y,u.userData.baseRotY=i;let y=new X(new aa(o+.4,s+.4,.5),new Vr({visible:!1}));y.userData.isClickBubble=!0,u.add(y),Hd(e,t,n,u)},void 0,e=>console.error(`Failed to load ${r.src}:`,e))}var Kd=[],qd=[],Jd=9.5,Yd=Math.PI*.85,Xd=Math.PI/2-Yd/2,Zd=new ya({color:16447214,roughness:.45,metalness:.02}),Qd=new ya({color:16777215,roughness:.3,metalness:.04}),$d=new ya({color:16513783,roughness:.45,metalness:.06,emissive:new Y(16774366),emissiveIntensity:.05});for(let e=0;e<5;e++){let t=Xd+e/4*Yd,n=Math.cos(t)*Jd,r=-Math.sin(t)*Jd-1.5,i=new wn;i.position.set(n,0,r);let a=new X(new aa(1.2,3,1.2),Zd);a.position.y=1.5,a.castShadow=!0,a.receiveShadow=!0,i.add(a);let o=new X(new aa(1.38,.1,1.38),Qd);o.position.y=3.05,o.castShadow=!0,o.receiveShadow=!0,i.add(o);let s=.92,c=new X(new aa(s,s,s),$d.clone());c.position.y=3.1+s/2,c.castShadow=!0,c.receiveShadow=!0,c.userData.idx=e,c.userData.baseY=c.position.y,c.userData.baseRotY=0,i.add(c),qd.push(c);let l=new G(0-n,0,12-r).normalize(),u=Math.atan2(l.x,l.z),d=pd[e].model;d.kind===`glb`?Wd(e,i,c,d,u):d.kind===`framed-image`&&Gd(e,i,c,d,u);let f=document.createElement(`canvas`);f.width=256,f.height=256;let p=f.getContext(`2d`);p.fillStyle=`#faf6ee`,p.fillRect(0,0,256,256),p.fillStyle=`#1a1814`,p.font=`italic 120px "Cormorant Garamond", serif`,p.textAlign=`center`,p.textBaseline=`middle`,p.fillText([`I`,`II`,`III`,`IV`,`V`][e],128,140);let m=new ta(f);m.anisotropy=8;let h=new ya({map:m,roughness:.8}),g=new X(new ca(.42,.42),h);g.position.set(0,2.25,.71),i.add(g);let _=new ho(16774366,1.4,18,Math.PI/6.5,.45,1.3);_.position.set(n,10,r),_.target.position.set(n,0,r),_.castShadow=!0,_.shadow.mapSize.set(1024,1024),_.shadow.bias=-8e-4,hd.add(_),hd.add(_.target),Nd(n,r),i.userData.idx=e,Kd.push(i),hd.add(i)}var ef=new G(.8,1.6,14),tf=new G(.4,2,5),nf=new G(0,3.7,12),rf=new G(0,2.6,-4);gd.position.copy(ef),gd.lookAt(tf);var af=`intro`,of=-1,sf=ef.clone(),cf=tf.clone(),lf=tf.clone(),uf=!1,df=0,ff=2400;function pf(e){return e===1?1:1-2**(-10*e)}function mf(e){if(af===`zooming`)return;of=e,af=`zooming`;let t=Kd[e].position,n=new G(nf.x-t.x,0,nf.z-t.z).normalize();sf.set(t.x+n.x*3,3.6,t.z+n.z*3),cf.set(t.x,3.5,t.z);let r=pd[e];document.getElementById(`p-num`).textContent=r.num,document.getElementById(`p-type`).textContent=r.type||``,document.getElementById(`p-title`).textContent=r.title,document.getElementById(`p-medium`).textContent=r.medium,document.getElementById(`p-desc`).innerHTML=r.desc,document.getElementById(`p-interp`).innerHTML=r.interp;let i=document.getElementById(`panel`);i.scrollTop=0,setTimeout(()=>{i.classList.add(`open`),i.scrollTop=0,document.getElementById(`back-btn`).classList.add(`visible`),af=`zoomed`},900),document.getElementById(`gallery-ui`).classList.add(`hidden`),document.querySelectorAll(`.nav-dot`).forEach((t,n)=>{t.classList.toggle(`active`,n===e)})}function hf(){af=`zooming`,of=-1,sf.copy(nf),cf.copy(rf),document.getElementById(`panel`).classList.remove(`open`),document.getElementById(`back-btn`).classList.remove(`visible`),document.getElementById(`gallery-ui`).classList.remove(`hidden`),document.querySelectorAll(`.nav-dot`).forEach(e=>e.classList.remove(`active`)),setTimeout(()=>{af=`gallery`},900)}var gf=new Ho,_f=new W,vf=-1;function yf(e){let t=md.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top;_f.x=n/t.width*2-1,_f.y=-(r/t.height)*2+1}function bf(e){let t=e;for(;t;){if(qd.indexOf(t)!==-1)return t;t=t.parent}return null}md.addEventListener(`pointermove`,e=>{if(af!==`gallery`)return;yf(e),gf.setFromCamera(_f,gd);let t=gf.intersectObjects(qd,!0);if(t.length>0){let e=bf(t[0].object);if(e){vf=e.userData.idx,md.classList.add(`hover`);return}}vf=-1,md.classList.remove(`hover`)}),md.addEventListener(`click`,e=>{if(af!==`gallery`)return;yf(e),gf.setFromCamera(_f,gd);let t=gf.intersectObjects(qd,!0);if(t.length>0){let e=bf(t[0].object);e&&mf(e.userData.idx)}}),document.querySelectorAll(`.nav-dot`).forEach(e=>{e.addEventListener(`click`,()=>{let t=parseInt(e.dataset.idx,10);af===`gallery`?mf(t):af===`zoomed`&&(document.getElementById(`panel`).classList.remove(`open`),setTimeout(()=>mf(t),320))})}),document.getElementById(`back-btn`).addEventListener(`click`,hf),document.getElementById(`close-panel`).addEventListener(`click`,hf),document.getElementById(`enter-btn`).addEventListener(`click`,()=>{document.getElementById(`intro`).classList.add(`gone`),setTimeout(()=>{uf=!0,df=performance.now(),sf.copy(nf),cf.copy(rf),af=`waking`},200)}),document.getElementById(`cite-btn`).addEventListener(`click`,()=>{document.getElementById(`cite-modal`).classList.add(`open`)}),document.getElementById(`curator-btn`).addEventListener(`click`,()=>{document.getElementById(`curator-modal`).classList.add(`open`)}),document.querySelectorAll(`.modal`).forEach(e=>{e.querySelector(`.close`).addEventListener(`click`,()=>e.classList.remove(`open`)),e.addEventListener(`click`,t=>{t.target===e&&e.classList.remove(`open`)})}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`&&(document.querySelectorAll(`.modal.open`).forEach(e=>e.classList.remove(`open`)),af===`zoomed`&&hf()),af===`zoomed`){if(e.key===`ArrowRight`&&of<4){let e=of+1;document.getElementById(`panel`).classList.remove(`open`),setTimeout(()=>mf(e),320)}if(e.key===`ArrowLeft`&&of>0){let e=of-1;document.getElementById(`panel`).classList.remove(`open`),setTimeout(()=>mf(e),320)}}}),window.addEventListener(`resize`,()=>{gd.aspect=window.innerWidth/window.innerHeight,gd.updateProjectionMatrix(),_d.setSize(window.innerWidth,window.innerHeight)});var xf=new Go,Sf=0;function Cf(){let e=xf.getDelta();if(Sf+=e,uf){let e=performance.now()-df,t=Math.min(e/ff,1);_d.toneMappingExposure=.32+pf(t)*.56,t>=1&&(uf=!1,af=`gallery`)}let t=af===`waking`?.025:.055;gd.position.lerp(sf,t),lf.lerp(cf,t),gd.lookAt(lf),qd.forEach((t,n)=>{let r=Math.sin(Sf*.7+n*1.3)*.015,i=t.userData.baseY+r,a=.05;if(vf===n&&af===`gallery`?(i+=.12,a=.22,t.rotation.y+=e*.8):of===n&&af===`zoomed`&&(t.rotation.y+=e*.4,a=.16),t.userData.materials)t.userData.materials.forEach(e=>{e.emissiveIntensity=Dt.lerp(e.emissiveIntensity,a,.08)});else if(t.material){let e=t.material;e.emissiveIntensity=Dt.lerp(e.emissiveIntensity,a,.08)}t.position.y=Dt.lerp(t.position.y,i,.12)});let n=zd.geometry.attributes.position;for(let e=0;e<Pd;e++)n.array[e*3+0]+=Ld[e*3+0]+Math.sin(Sf*.3+Rd[e])*8e-4,n.array[e*3+1]+=Ld[e*3+1]+Math.cos(Sf*.25+Rd[e])*6e-4,n.array[e*3+2]+=Ld[e*3+2]+Math.sin(Sf*.35+Rd[e]+1.5)*8e-4,(n.array[e*3+0]>16||n.array[e*3+0]<-16)&&(Ld[e*3+0]*=-1),(n.array[e*3+1]>11||n.array[e*3+1]<.5)&&(Ld[e*3+1]*=-1),(n.array[e*3+2]>8||n.array[e*3+2]<-16)&&(Ld[e*3+2]*=-1);n.needsUpdate=!0,_d.render(hd,gd),requestAnimationFrame(Cf)}Cf();